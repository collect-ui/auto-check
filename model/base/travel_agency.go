...
type TravelAgency struct {
	...
	DeepseekAPIKey         string `gorm:"column:deepseek_api_key" json:"deepseek_api_key"`
	...
	EscapeRepeatAdKeywords string `gorm:"column:escape_repeat_ad_keywords" json:"escape_repeat_ad_keywords"`
}
