...
type TravelEmployee struct {
	...
	EscapeLastAnalyzeTime string  `gorm:"column:escape_last_analyze_time" json:"escape_last_analyze_time"`
	EscapeIsEscape        int     `gorm:"column:escape_is_escape" json:"escape_is_escape"`
	EscapeAiContent       string  `gorm:"column:escape_ai_content" json:"escape_ai_content"`
